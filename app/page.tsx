...
const LISTINGS = [
  ...
  },
  {
    ...
    lossNarrative: `They offered $3,800,000 and, at Ms. Carmichael's suggestion, wrote a letter. It was a good letter. It mentioned the hill, the grandparents, St. Kevin's, Cortez the basset hound. Ms. Reyes cried a little writing it, which she had not planned to do. The sellers received fourteen offers. The house sold for $4,650,000 — $1,151,000 over asking — to a buyer who had also grown up in the neighborhood. His parents, Ms. Carmichael mentioned, had been active in the designation of the Bernal Heights Special Use District — the zoning protections widely credited with preserving the neighborhood's character, its independent businesses, its architectural integrity, and, not incidentally, its property values. Upon hearing of the sale, the buyer's parents reportedly expressed relief that gentrifiers weren't moving into the neighborhood. The buyer works in artificial intelligence. He did not write a letter. He did not need to. "Letters are lovely," Ms. Carmichael said, later, carefully. "They don't appraise."`,
  },
];
