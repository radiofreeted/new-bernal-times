    ...
    <div className="max-w-4xl mx-auto px-4">
      ...
      <article className="max-w-2xl mx-auto">
        ...
        <div className="text-[16px] leading-relaxed text-[#333] space-y-4">
          ...
          <p>
            The decision to buy was accelerated, in February, by an unexpected development: Mr. Reyes won $6,100,000 in the California Lottery. A Powerball ticket purchased at the Valero on Cortland, selected using Cora&apos;s birthday and a number Mr. Reyes described as &ldquo;just a feeling.&rdquo; After taxes, the family cleared approximately $4,200,000. They set aside $1,000,000 for property taxes, maintenance, and what Ms. Reyes called &ldquo;the inevitable thing we don&apos;t know about yet,&rdquo; put $3,200,000 toward a down payment, and secured a $1,000,000 jumbo loan — arriving at a total budget of $4,200,000. &ldquo;We won the lottery,&rdquo; Ms. Reyes said. &ldquo;Literally. We won the lottery.&rdquo; She let that sit for a moment. &ldquo;And we still weren&apos;t sure it would be enough.&rdquo;
          </p>
        </div>
