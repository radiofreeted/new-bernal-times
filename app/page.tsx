    ...
    <div className="max-w-4xl mx-auto px-4">
      ...
      <article className="max-w-2xl mx-auto">
        ...
        <div className="text-[16px] leading-relaxed text-[#333] space-y-4">
          ...
          <p>
            Both grew up on the eastern slope of the hill — Mr. Reyes on Precita Avenue, Ms. Reyes on Eugenia Street, four blocks apart, their childhoods running parallel without quite touching. They left for college, returned to the city within a year of each other, and eventually landed in a two-bedroom rental on Andover Street, two blocks from Mr. Reyes&apos;s parents and four from Ms. Reyes&apos;s. Mr. Reyes works in grant writing for a Mission District nonprofit focused on housing stability; Ms. Reyes is an adjunct professor of English at City College of San Francisco. Their dog, a basset hound named Cortez, occupies most of the couch.
          </p>
          <p>
            The decision to buy was accelerated, in February, by an unexpected development: Mr. Reyes won $6,100,000 in the California Lottery. A Powerball ticket purchased at Andi&apos;s Market on Cortland, selected using Cora&apos;s birthday and a number Mr. Reyes described as &ldquo;just a feeling.&rdquo; After taxes, the family cleared approximately $4,200,000. They set aside $1,000,000 for property taxes, maintenance, and what Ms. Reyes called &ldquo;the inevitable thing we don&apos;t know about yet,&rdquo; put $3,200,000 toward a down payment, and secured a $1,000,000 mortgage — arriving at a total budget of $4,200,000. &ldquo;We won the lottery,&rdquo; Ms. Reyes said. &ldquo;Literally. We won the lottery.&rdquo; She let that sit for a moment. &ldquo;And we still weren&apos;t sure it would be enough.&rdquo;
          </p>
        </div>
        ...
        <div className="text-[16px] leading-relaxed text-[#333] space-y-4 mb-8">
          <p>
            Between the lottery winnings, their savings, and a $1,000,000 mortgage, the couple assembled a budget of approximately $4,200,000 and confined their search to Bernal Heights proper. Must-haves included four bedrooms, a yard generous enough for Cortez to stage his daily dramatic collapses, and proximity to the J-Church line for Ms. Reyes&apos;s commute to the Castro.
          </p>
          <p>
